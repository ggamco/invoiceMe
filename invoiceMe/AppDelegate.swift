...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        TOKEN_DEVICE = UIDevice.current.identifierForVendor!.uuidString
        print("====== device id =======")
        print(TOKEN_DEVICE)
    ...
    func personalizaUI(){
        ...
        navBar.tintColor = CONSTANTES.COLORES.NAV_ITEMS
        navBar.titleTextAttributes = [NSAttributedStringKey.foregroundColor : CONSTANTES.COLORES.NAV_ITEMS, NSAttributedStringKey.font: font!]
